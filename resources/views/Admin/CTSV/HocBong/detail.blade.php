...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="">
            ...
            <div class="form-group row">
                <label class="col-sm-3">Số lượng đã đăng ký :</label>
                <div class="col-sm-9">
                    <p class="mb-0">{{$detail->hocbong_soluongdadangky}}</p>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <p class="mb-0">{{date('d/m/Y H:i', strtotime($detail->hocbong_ngayduyet))}}</p>
                </div>
            </div>
            <hr>

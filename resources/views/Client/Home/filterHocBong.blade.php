...
<div class="row mt-4">
            <div class="col-sm-12 text-right text-center-xs">
                <div class="pagination d-flex justify-content-center mr-4"> {{$get_all_hocbong->links('paginationlinks')}}</div>
            </div>
        </div>
